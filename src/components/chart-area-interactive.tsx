...
export function ChartAreaInteractive({
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>Matric Pass Rate</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            NCS pass rate since 2010 and Number of Student
          </span>
        ...
        <CardAction>
          ...
          >
            <ToggleGroupItem value="90d">Last 3 years</ToggleGroupItem>
            {/* <ToggleGroupItem value="30d">Last 30 days</ToggleGroupItem> */}
            <ToggleGroupItem value="7d">Last 5 years</ToggleGroupItem>
          </ToggleGroup>

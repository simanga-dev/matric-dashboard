    ...
    for await (const record of parser) {
      ...
      if (insertedSchool) {
        await db.insert(marks).values({
          ...
          tolal_archieved: record["2021_archived_no"], // use correct field name
        ...
        await db.insert(marks).values({
          ...
          tolal_archieved: record["2022_archived_no"], // use correct field name
        ...
        await db.insert(marks).values({
          ...
          tolal_archieved: record["2023_archived_no"], // use correct field name
